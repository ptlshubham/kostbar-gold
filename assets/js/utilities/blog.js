...
class Blog {
    ...
    createCategoryWidget(data) {
        if(document.querySelector('.widget-categories') !== null) {
            ...
            categoryFilter.forEach(eachData => {
                this.categoryWrap.innerHTML += `<li><a href="${this.sanitizePath}-find.html?category=${eachData.category.toLowerCase()}">${eachData.category}<span class="uk-label in-label-small uk-float-right">${eachData.totalPost}</span></a></li>`
            })
        }
    }
    ...
    <div class="uk-card-footer uk-clearfix">
        <div class="uk-float-left">
            <span class="uk-label in-label-small">${category}</span>
        </div>
        <div class="uk-float-right">
            <a href="${this.sanitizePath}/${link}" class="uk-button uk-button-text">Read more</a>
        </div>
    </div>
</article>`
    }
